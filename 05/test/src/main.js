...
//平行光源
const directionalLight = new THREE.DirectionalLight(0xff00ff, 3);
...
mtlLoader.load("models/dog/Shiba Inu-bl.mtl", (materials) => {
  materials.preload();

  //OBJデータの読み込み
  const objLoader = new OBJLoader();
  objLoader.setMaterials(materials);
  objLoader.load("models/dog/Shiba Inu-bl.obj", (obj) => {
    group.add(obj);
